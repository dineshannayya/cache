...
########### config.tcl ##################
# User config
set ::env(DESIGN_NAME) icache_top

# Change if needed
set ::env(VERILOG_FILES) [glob     \
         ../src/core/icache_tag_fifo.sv \
         ../src/core/icache_app_fsm.sv      \
         ../src/core/icache_top.sv      \
	]


set ::env(SYNTH_DEFINES) [list SYNTHESIS ]
set ::env(VERILOG_INCLUDE_DIRS) "./src/core"
set ::env(EXTRA_LIBS) "../lib/sky130_sram_2kbyte_1rw1r_32x512_8_TT_1p8V_25C.lib"
